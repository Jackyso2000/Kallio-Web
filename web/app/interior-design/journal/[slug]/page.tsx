    ...
    <Layout>
      <div className="bg-white pb-24">
        ...
        <div className="container mx-auto px-4 max-w-3xl">
          <div className="prose prose-lg text-black prose-headings:font-light prose-headings:text-black prose-p:text-black prose-p:font-normal prose-p:leading-relaxed prose-a:text-[#680c09] prose-strong:text-black prose-li:text-black max-w-none">
            {post.body ? (
