      ...
      <div className="min-h-screen">
        <div className="container mx-auto px-4 py-32">
          ...
          <div className="space-y-4 prose prose-lg max-w-none text-brand-text">
            ...
            <p>
              By accessing the website at Kallio Design, you are agreeing to be bound by these
            ...
            <p>
              ...
              or software) on Kallio Design's website for personal, non-commercial transitory
              viewing only.
            </p>
          </div>
        </div>
